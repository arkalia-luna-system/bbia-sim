...
from src.bbia_sim.daemon.middleware import SecurityMiddleware, RateLimitMiddleware
...
class TestRateLimitMiddleware:
    ...
    def test_rate_limit_reset(self, app, client):
        ...
        app.add_middleware(RateLimitMiddleware, requests_per_minute=1, window_seconds=1, force_enable=True)
    ...
    def test_rate_limit_custom_message(self, app, client):
        ...
        app.add_middleware(RateLimitMiddleware, requests_per_minute=1, message="Custom rate limit message", force_enable=True)
