...
class TestBBIAIntegrationRapid:
    ...
    def test_apply_emotion_to_robot(self, mock_service, mock_behavior, mock_vision, mock_emotions):
    ...
    @patch("bbia_sim.bbia_integration.BBIABehaviorManager")
    @patch("bbia_sim.bbia_integration.SimulationService")
    def test_react_to_face_detection(self, mock_service, mock_behavior, mock_vision, mock_emotions):
    ...
    @patch("bbia_sim.bbia_integration.BBIABehaviorManager")
    @patch("bbia_sim.bbia_integration.SimulationService")
    def test_react_to_sound(self, mock_service, mock_behavior, mock_vision, mock_emotions):
