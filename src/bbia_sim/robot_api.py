...
class RobotAPI(ABC):
    ...
    def __init__(self):
        ...
        self.joint_limits = {}
        self.forbidden_joints = {"left_antenna", "right_antenna", "passive_1", "passive_2", "passive_3", "passive_4", "passive_5", "passive_6", "passive_7"}
    ...
    def set_emotion(self, emotion: str, intensity: float = 0.5) -> bool:
        ...
        valid_emotions = {"neutral", "happy", "sad", "angry", "surprised", "confused", "determined", "nostalgic", "proud"}
    ...
    def run_behavior(self, behavior_name: str, duration: float = 5.0, **kwargs) -> bool:
        ...
        valid_behaviors = {"wake_up", "greeting", "emotional_response", "vision_tracking", "conversation", "antenna_animation", "hide"}
    ...
    def clamp_joint_position(self, joint_name: str, position: float) -> float:
        ...
        # Limites générales
        position = max(-self.safe_amplitude_limit, min(self.safe_amplitude_limit, position))
