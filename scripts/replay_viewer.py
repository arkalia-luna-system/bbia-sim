...
class AnimationRecorder:
    ...
    def stop_recording(self):
        ...
        print(f"💾 Enregistrement sauvegardé: {len(self.records)} frames → {self.record_path}")
...
def main():
    ...
    parser.add_argument("--model", default="src/bbia_sim/sim/models/reachy_mini_REAL_OFFICIAL.xml", help="Modèle MuJoCo")
    ...
    if replayer.load_recording():
        ...
        print(f"📊 Informations enregistrement:")
