...
LINK_FIXES = [
    ...
    (r"\[([^\]]+)\]\(\.\./guides/GUIDE_DEBUTANT\.md\)", r"[\1](../guides/GUIDE_DEBUTANT.md)"),
    (r"\[([^\]]+)\]\(docs/guides/GUIDE_DEBUTANT\.md\)", r"[\1](../guides/GUIDE_DEBUTANT.md)"),
    (r"\[([^\]]+)\]\(GUIDE_DEBUTANT\.md\)", r"[\1](../guides/GUIDE_DEBUTANT.md)"),
    
    # Corrections STATUT_PROJET
    (r"\[([^\]]+)\]\(docs/STATUT_PROJET\.md\)", r"[\1](../references/STATUT_PROJET.md)"),
    ...
    (r"\[([^\]]+)\]\(docs/ARCHITECTURE\.md\)", r"[\1](../architecture/ARCHITECTURE.md)"),
    (r"\[([^\]]+)\]\(ARCHITECTURE\.md\)", r"[\1](../architecture/ARCHITECTURE.md)"),
    
    # Corrections corrections/
    (r"\[([^\]]+)\]\(corrections/TOUTES_DEMOS_CORRIGEES\.md\)", r"[\1](../archives/corrections_terminees/TOUTES_DEMOS_CORRIGEES.md)"),
    (r"\[([^\]]+)\]\(corrections/DEMO_3D_CORRIGEE\.md\)", r"[\1](../corrections/DEMO_3D_CORRIGEE.md)"),
    (r"\[([^\]]+)\]\(corrections/CORRECTIONS_DEMOS_REACHY\.md\)", r"[\1](../corrections/CORRECTIONS_DEMOS_REACHY.md)"),
    
    # Corrections conformite/
    (r"\[([^\]]+)\]\(conformite/CONFORMITE_REACHY_MINI_COMPLETE\.md\)", r"[\1](../conformite/CONFORMITE_REACHY_MINI_COMPLETE.md)"),
    (r"\[([^\]]+)\]\(conformite/ANALYSE_CONFORMITE_REACHY_MINI\.md\)", r"[\1](../conformite/ANALYSE_CONFORMITE_REACHY_MINI.md)"),
