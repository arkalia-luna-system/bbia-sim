...
|---|---------|--------|--------|-------|
| 1 | **Technique** | Tests réels Reachy Mini | ⏳ En attente robot | Oct / No2025025025025025 |
...
- **Statut** : ⏳ **EN ATTENTE** du robot physique (Oct / No2025025025025025)
...
### Actions robot physique (Oct / No2025025025025025)
