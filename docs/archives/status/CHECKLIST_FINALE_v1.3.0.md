...
|---|---------|--------|--------|-------|
| 1 | **Technique** | Tests réels Reachy Mini | ⏳ En attente robot | Oct / Oct / Nov. 20255 |
...
- **Statut** : ⏳ **EN ATTENTE** du robot physique (Oct / Oct / Nov. 20255)
...
### Actions robot physique (Oct / Oct / Nov. 20255)
