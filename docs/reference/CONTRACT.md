...
>
> Voir `docs/reference/project-status.md` → "État par axe" (API/SDK, pagination/filtre REST, WS versionné) pour l’état et les axes futurs.
...
def connect(self) -> bool:
    """Connecte au hardware/simulateur.
...
def disconnect(self) -> bool:
    """Déconnecte du hardware/simulateur.
