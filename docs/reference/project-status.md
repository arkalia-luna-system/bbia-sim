...
|---------|--------|---------|
| Lignes ≤ 100 chars | ✅ | **0 ligne > 100 chars** (44 lignes corrigées, Oct / Nov. 2025) |
...
- Endpoints mis à jour: `/development/api/state/full`, `/development/api/state/battery`, `/development/api/state/temperature`, `/development/api/state/sensors`
...
### 🔐 Synthèse conformité SDK Reachy Mini (Oct / Nov. 2025)
...
4. **Audit robot_api.py** : Cloner référence Reachy, comparer API, constantes, unités
   - Créer section dans `docs/reference/project-status.md` avec références précises
