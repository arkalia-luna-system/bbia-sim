...
- ℹ️ Fichiers dans `docs/archive/` mentionnent l'ancien état (intentionnel)
...
Les fichiers dans `docs/archive/` sont conservés comme références historiques et ne sont **PAS modifiés** intentionnellement.
