...
- `docs/guides_techniques/AUDIT_VISION_WEBCAM.md`
...
**Ce qui existe:**
- ✅ Endpoint `/api/state/present_body_yaw` (`daemon/app/routers/state.py` ligne 438)
...
- ✅ Endpoint `/api/move/play/recorded-move-dataset/{dataset}/{move_name}` (`move.py` ligne 212)
...
- ✅ Endpoint REST `/api/motors/factory-reset`
- ✅ Documentation
...
**Contribution possible:**
- ✅ Implémenter `/api/daemon/update` endpoint
- ✅ Gestion updates OTA
