...
- ✅ Liens vers archives : `../archives/conformite/`
- ✅ Liens vers guides : `../guides/` ou `../guides_techniques/`
...
├── guides_techniques/   # Guides techniques (migration, testing, etc.)
├── architecture/       # Architecture détaillée
├── audit/              # Audits, comparaisons, bilans
├── conformite/         # Tests conformité SDK
├── ci/                 # Documentation CI/CD
├── observabilite/      # Logs, métriques, health checks
├── api/                # Documentation API REST/WebSocket
├── dashboard/          # Roadmap dashboard/UX
├── performance/        # Optimisations performance
└── references/         # Index, historique projet
```
...
4. `docs/FAQ.md` - Questions fréquentes
...
- `docs/architecture/ARCHITECTURE_OVERVIEW.md` - Vue d'ensemble architecture
- `docs/audit/RESUME_ETAT_ACTUEL_BBIA.md` - État actuel détaillé
