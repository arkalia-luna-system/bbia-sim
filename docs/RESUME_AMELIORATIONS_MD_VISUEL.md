...
graph TB
    subgraph "Architecture"
        A1[Diagrammes Architecture<br/>12+ flowchart/graph]
        A2[Séquences Interactions<br/>2 sequenceDiagram]
    end
    
    subgraph "Navigation"
        N1[Parcours Utilisateur<br/>Flowcharts démarrage]
        N2[Mindmap Organisation<br/>2 mindmap]
    end
    
    subgraph "Statistiques"
        S1[Scores Parité<br/>Pie charts]
        S2[Timeline<br/>Gantt]
        S3[Statut<br/>State diagrams]
    end
...
```mermaid
pie title Qualité Documentation
    "Visuel & Diagrammes" : 40
    "Structure & Navigation" : 30
    "Contenu Technique" : 20
    "Cohérence" : 10
```
