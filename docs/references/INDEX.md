...
|--------|--------------|---------|
| Développeur débutant | [Guide Débutant](../guides/GUIDE_DEBUTANT.md) | [Examples](../../examples/) |
...
|---------|-------------|--------|
| [Statut Projet](../status.md) | État actuel, dashboard, tests | Tous |
| [Guide Débutant](../guides/GUIDE_DEBUTANT.md) | Premiers pas avec BBIA | 🟢 Débutant |
| [Guide Avancé](../guides/GUIDE_AVANCE.md) | Développement avancé | 🟡 Expert |
| [Guide Chat BBIA](../guides/GUIDE_CHAT_BBIA.md) | Chat intelligent | 🟡 Intermédiaire |

### 🏗️ **Architecture & Technique**

| Document | Description | Niveau |
|---------|-------------|--------|
| [Architecture](../architecture/ARCHITECTURE.md) | Index architecture | Tous |
| [Architecture Overview](../architecture/ARCHITECTURE_OVERVIEW.md) | Vue d'ensemble | Tous |
| [Architecture Detailed](../architecture/ARCHITECTURE_DETAILED.md) | Détails techniques | Expert |
| [Guide Tests](../GUIDE_SYSTEME_TESTS.md) | Suite de tests | Intermédiaire |
...
→ [Guide Débutant](../guides/GUIDE_DEBUTANT.md) (5 minutes)

#### **... Comprendre l'état actuel**
→ [Statut Projet](../status.md) (métriques, tests, dashboard)

#### **... Développer des fonctionnalités**
→ [Guide Avancé](../guides/GUIDE_AVANCE.md)

#### **... Comprendre l'architecture**
→ [Architecture Overview](../architecture/ARCHITECTURE_OVERVIEW.md) → [Architecture Detailed](../architecture/ARCHITECTURE_DETAILED.md)

#### **... Créer des tests**
→ [Guide Tests](../GUIDE_SYSTEME_TESTS.md)
