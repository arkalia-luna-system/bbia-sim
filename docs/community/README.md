...
- **[CONTRIBUTION_GUIDE.md](CONTRIBUTION_GUIDE.md)** : Guide complet pour les contributeurs (détails techniques).
...
**Getting Started** : [Guide Démarrage](../getting-started/README.md)
