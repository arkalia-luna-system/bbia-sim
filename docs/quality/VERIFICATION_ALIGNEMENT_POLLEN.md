...
**Date** : 9 mars 2026  
**Référence** : [pollen-robotics/reachy_mini](https://github.com/pollen-robotics/reachy_mini) **v1.5.0** (5 mars 2026)
...
|--------|------------------------|--------|
| **Version SDK** | ✅ Même | reachy-mini **1.5.0** (référence), compatibilité maintenue 1.3.0+ |
...
| **Documentation** | ✅ À jour | Doc BBIA mise à jour (v1.3.0, 7 fév. 2026) ; doc officielle = Hugging Face |
...
- **Pollen (v1.5.0)** : `reachy_mini` 1.5.0 sur PyPI, `reachy_mini_motor_controller` ≥1.5.5, numpy 2.x, websockets, zenoh, kinematics, huggingface-hub, etc. (voir `pyproject.toml` officiel).
