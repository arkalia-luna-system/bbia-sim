...
#### 2.1. `GET /development/api/move/running`
...
#### 2.2. `POST /development/api/move/stop`
...
#### 2.3. `WebSocket /development/api/move/ws/updates`
...
#### 2.4. `POST /development/api/move/set_target`
...
#### 2.5. `WebSocket /development/api/move/ws/set_target`
...
#### 2.6. `GET /development/api/move/recorded-move-datasets/list/{dataset_name:path}`
...
#### 2.7. `POST /development/api/move/play/recorded-move-dataset/{dataset_name:path}/{move_name}`
...
### 3. Paramètres `/development/api/state/full` incomplets
...
**Endpoint** : `GET /development/api/state/present_head_pose`
...
### 5. WebSocket `/development/api/state/ws/full` paramètres incomplets

**Endpoint** : `WebSocket /development/api/state/ws/full`
...
- `/development/api/motion/head` - Contrôle tête spécifique
- `/development/api/motion/custom` - Commandes personnalisées
- `/development/api/state/simulation/*` - Contrôle simulation
- `/development/api/sanity/*` - Health checks
...
- [x] **CRIT-1** : Adapter `POST /development/api/move/goto` avec `GotoModelRequest` ✅
  - **Fichier** : `src/bbia_sim/daemon/app/routers/move.py:150`
  - **Action** : Modèle `GotoModelRequest` créé, route `/development/api/move/goto`, retourne `MoveUUID` ✅
...
- [x] **MED-5** : Compléter paramètres WebSocket `/development/api/state/ws/full` ✅
...
- ✅ `POST /development/api/move/play/wake_up` - Réveil (retour UUID)
- ✅ `POST /development/api/move/play/goto_sleep` - Veille (retour UUID)
- ✅ `WebSocket /development/api/move/ws/updates` - Stream updates
- ✅ `POST /development/api/move/set_target` - Set target direct
- ✅ `WebSocket /development/api/move/ws/set_target` - Stream set_target
- ✅ `GET /development/api/state/full` - 11 paramètres optionnels
- ✅ `GET /development/api/state/present_head_pose` - Paramètre `use_pose_matrix`
...
- ✅ `/development/api/motors/*` - 100% conforme
- ✅ `/development/api/daemon/*` - 100% conforme
- ✅ `/development/api/apps/*` - 100% conforme
- ✅ `/development/api/kinematics/*` - 100% conforme
- ✅ `/development/api/state/present_head_pose` - Compatible (manque use_pose_matrix)
- ✅ `/development/api/state/present_body_yaw` - 100% conforme
- ✅ `/development/api/state/present_antenna_joint_positions` - 100% conforme
- ✅ `/development/api/motion/wake_up` - Compatible (retour différent)
- ✅ `/development/api/motion/goto_sleep` - Compatible (retour différent)
