...
#### 1. Router `/development/api/move` conforme SDK ✅
...
- ✅ `POST /development/api/move/play/wake_up` - Réveil (retour `MoveUUID`)
- ✅ `POST /development/api/move/play/goto_sleep` - Veille (retour `MoveUUID`)
- ✅ `WebSocket /development/api/move/ws/updates` - Stream updates mouvements
...
#### 3. Endpoint `/development/api/state/full` amélioré ✅
...
#### 4. Endpoint `/development/api/state/present_head_pose` amélioré ✅
...
#### 5. WebSocket `/development/api/state/ws/full` amélioré ✅
...
- ✅ `docs/quality/compliance/CHECKLIST_FINALE_CONFORMITE.md` - Checklist mise à jour
- ✅ `docs/quality/audits/SUITE_ACTIONS_CONFORMITE.md` - Statut mis à jour
- ✅ `docs/quality/compliance/CONFORMITE_REACHY_MINI_COMPLETE.md` - Conformité mise à jour
