...
class BBIAVisualizer:
    ...
    async def demo_wave_movement(self):
        ...
        movements = [
            ("Position initiale", {"right_shoulder_pitch": -0.3, "right_elbow_pitch": 0.0}),
            ("Lever le bras", {"right_shoulder_pitch": -0.8, "right_elbow_pitch": -0.5}),
            ("Mouvement salut", {"right_shoulder_pitch": -0.6, "right_elbow_pitch": -0.3}),
            ("Retour initial", {"right_shoulder_pitch": -0.3, "right_elbow_pitch": 0.0}),
        ]
...
async def main():
    ...
    parser.add_argument("--token", default="bbia-secret-key-dev", help="Token d'authentification")
    parser.add_argument("--demo", choices=["wave", "head", "monitor"], default="wave", help="Type de démo")
