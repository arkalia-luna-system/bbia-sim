#!/usr/bin/env python3
"""Script de test pour les tests de performance."""
...
def main():
    ...
    ] + performance_tests, "Tests de performance avec couverture")
    
    # Résumé
    print("\n📊 Résumé")
    print(f"Tests de performance: {'✅' if success else '❌'}")
    ...
    if success:
        ...
        print("\n💥 Les tests de performance ont échoué")
        sys.exit(1)
